<?php
	...
	else
	{
		if(!empty($_POST['old_password']))
		{
			...
			{
				echo '<h1>Erreur</h1>Les nouveaux mots de passe ne sont pas cohérents.';
				echo '<br /><a href="index.php5?page=profil">Retour à votre profil</a>';
			}
			else
			{
				...
				{
					echo '<h1>Erreur</h1>Le mot de passe entré ne correspond pas à celui du compte.';
					echo '<br /><a href="index.php5?page=profil">Retour à votre profil</a>';
				}
				else
				{
					...
					if(db_query($query))
					{
						echo '<h1>Modifications effectuées</h1>Les nouvelles informations entrées ont bien été enregistrées.';
						echo '<br /><a href="index.php5?page=profil">Retour à votre profil</a>';
					}
					else
					{
